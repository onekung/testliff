<template>
  <div class="home">
    <div class="home__badges">
      <img v-if="profile" :src="`${profile.pictureUrl}`">
    </div>
    <div class="home__buttons">
      <span v-if="profile" class="home__badges__badge badge--primary"> {{ profile.displayName }} </span>
      <button v-if="profile" class="home__buttons__button" @click="logout()">Logout</button>
    </div>
  </div>
</template>
  ...
  methods: {
    async getUserProfile () {
      if (process.client) {
        ...
        this.accessToken = await this.$liff.getAccessToken()
